**Disclaimer** данный код был написан много лет назад школьницей для курсового проекта. Сейчас школьница давно выросла и работает программистом, но я храню его как пямять, и постоянно борюсь с желанием что-нибудь улучшить и дописать тот функционал, который был задуман, но в спешке не реализован. Стиль комментариев и именования функций и переменных остался без изменений :)
